...
namespace threadRace
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Task t1 = Task.Run(() =>
            {
                Thread.CurrentThread.Name = "Harry Potter";
                for (int i = 0; i < 100; i++)
                {
            ...
            Task t2 = Task.Run(() =>
            {
                Thread.CurrentThread.Name = "Hermonie Granger";
                for (int i = 0; i < 100; i++)
                {
                    if (t1Location < 100 && t2Location < 100 && t3Location < 100 && t4Location < 100 && t5Location < 100)
            ...
            Task t3 = Task.Run(() =>
            {
                Thread.CurrentThread.Name = "Ronald Weasley";
                for (int i = 0; i < 100; i++)
                {
                    if (t1Location < 100 && t2Location < 100 && t3Location < 100 && t4Location < 100 && t5Location < 100)
            ...
            Task t4 = Task.Run(() =>
            {
                Thread.CurrentThread.Name = "Neville Longbottom";
                for (int i = 0; i < 100; i++)
                {
                    if (t1Location < 100 && t2Location < 100 && t3Location < 100 && t4Location < 100 && t5Location < 100)
            ...
            Task t5 = Task.Run(() =>
            {
                Thread.CurrentThread.Name = "Luna Lovegood";
                for (int i = 0; i < 100; i++)
                {
                    if (t1Location < 100 && t2Location < 100 && t3Location < 100 && t4Location < 100 && t5Location < 100)
